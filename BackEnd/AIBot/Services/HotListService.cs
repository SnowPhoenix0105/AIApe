...
namespace Buaa.AIBot.Services
{
    ...
    public class HotListService : IHotListService
    {
        ...
        public HotListService(IQuestionRepository questionRepository, ILogger<HotListService> logger, TimeSpan hotValueFreshInterval, TimeSpan hotListFreshInterval, IServiceProvider serviceProvider, int length)
        {
            this.questionRepository = questionRepository;
            this.logger = logger;
            this.hotValueFreshInterval = hotValueFreshInterval;
        ...
        private async Task FreshHotValueAsync(CancellationTokenSource cts)
        {
            var ct = cts.Token;
            using var context = new IndependentDatabaseContext(serviceProvider.GetRequiredService<ILogger<IndependentDatabaseContext>>());

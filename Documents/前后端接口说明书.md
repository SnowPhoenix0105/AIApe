...
|URL|类型|权限|功能简介|
|:-|:-|:-|:-|
|[/api/message](#机器人消息 /api/message)|`POST`|`游客`|与机器人进行交互，具体接口参见[Bot Framework REST API](https://docs.microsoft.com/zh-cn/azure/bot-service/rest-api/bot-framework-rest-overview?view=azure-bot-service-4.0)|
...
|[/api/user/fresh](#刷新令牌-apiuserfresh)|`POST`|`用户`|刷新令牌|
...
* url格式：
```
{BASE_URL}/api/questions/answer?qid={qid}&aid={aid}
```
* 请求URL各参数含义：
  * `qid`：该回答所属的问题，uint；
